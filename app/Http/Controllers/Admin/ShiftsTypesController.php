...
$subject = get_cols_where(new Subject(), array("*"), array("com_code" => auth()->user()->com_code));
$week = get_cols_where(new Week(), array("*"), array("com_code" => auth()->user()->com_code));

return view('admin.ShiftsTypes.index', ['data' => $data,'subject'=>$subject,'week'=>$week]);
}
