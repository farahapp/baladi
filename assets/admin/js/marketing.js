...
$(document).on('input','#registeration_date_from', function(e){
    make_search();
});

$(document).on('input','#registeration_date_to', function(e){
    make_search();
});

$(document).on('input','#age_from', function(e){
    make_search();
});

$(document).on('input','#age_to', function(e){
    make_search();
});
...
function make_search() {
    ...
    var registeration_date_from = $("#registeration_date_from").val();
    var registeration_date_to = $("#registeration_date_to").val();
    ...
    jQuery.ajax({
        ...
        data: {
            ...
            registeration_date_from: registeration_date_from,
            registeration_date_to: registeration_date_to,
            age_from: age_from,
            age_to: age_to,
            "_token": token_search
        },
        success: function(data) {
            $("#marketing_searchDiv").html(data);
        },
        error: function(){
        }
    });
...
$(document).on('click','#driving_school_ajax_pagination_in_search a', function(e){
e.preventDefault();
 var search_by_text = $("#search_by_text").val();
