...
// $(document).on('change','#bulding_search', function(e){
//     make_search();
// });

$(document).on('change','#flats_search', function(e){
    make_search();
});
...
function make_search() {
    ...
    // var bulding_search = $("#bulding_search").val();
    var flats_search = $("#flats_search").val();
    ...
    jQuery.ajax({
        ...
        data: {
            ...
            // bulding_search: bulding_search,
            flats_search: flats_search,
            "_token": token_search
        },
        success: function(data) {
            $("#flats_searchDiv").html(data);
        },
        error: function(){}
    });
}
