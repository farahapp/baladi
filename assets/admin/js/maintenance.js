    ...
    function make_search() {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                $("#Vechile_Information_ajax_serachDiv").html(data);
            },
            error: function(){
            }
        });
...
$(document).on('click','.load_add_traffic_accidents', function(e){
    var id_value=$(this).data('id');
    var token_search = $("#token_search").val();
    var ajax_url = $("#ajax_load_add_traffic_accidents").val();
   jQuery.ajax({
        url: ajax_url,
        type: 'post',
        dataType: 'html',
        ...
        success: function(data) {
            $("#load_add_traffic_accidentsModalBody").html(data);
           $("#load_add_traffic_accidentsModal").modal("show");
           $('.select2').select2({
            theme: 'bootstrap4'
          });
        },
...
// ======================================================
$(document).on('click','.load_add_traffic_accident_parts', function(e){
    var id_value=$(this).data('id');
    var token_search = $("#token_search").val();
    var ajax_url = $("#ajax_search_load_add_traffic_accident_parts").val();
   jQuery.ajax({
        url: ajax_url,
        type: 'post',
        dataType: 'html',
        ...
        success: function(data) {
            $("#load_add_traffic_accident_partsModalBody").html(data);
           $("#load_add_traffic_accident_partsModal").modal("show");
           $('.select2').select2({
            theme: 'bootstrap4'
          });
        },
