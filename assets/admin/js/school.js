...
$(document).on('change','#driving_school_status_search', function(e){
    make_search();
});
...
function make_search() {
    ...
    jQuery.ajax({
        ...
        data: {
            ...
            driving_school_status_search: driving_school_status_search,
            Functional_status_search: Functional_status_search,
            "_token": token_search
        },
        success: function(data) {
            $("#driving_school_status_searchDiv").html(data);
        },
        error: function(){}
    });
}
