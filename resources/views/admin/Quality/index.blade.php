...
<a href="{{ route('Maintenance.index') }}">   حضور المتدربين   </a>
@endsection
...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  بيانات   حضور المتدربين 
         ...
         <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td style="background-color: CornflowerBlue;color:white">{{ $info->Employee->driver_name }}</td>
                  @else
