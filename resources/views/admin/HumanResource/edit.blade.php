               ...
               <div class="col-md-4">
                  <div class="form-group" id="driver_pasport_image_oldImage">
                     ...
                     <div class="image">
                        ...
                        <iframe  class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['driver_pasport_image'] }}"></iframe><br/>
                        @else
                        <img class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['driver_pasport_image'] }}" alt=" صورة توقيع اقرار تسليم الجواز " ><br/>
                        @endif
               ...
               <div class="col-md-4 related_does_has_sudanese_Driving_License"  @if($data['does_has_sudanese_Driving_License']==0) style="display: none" @endif>
                  <div class="form-group" id="sudanese_driving_license_Image_oldImage">
                     ...
                     <div class="image">
                        ...
                        <iframe  class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['sudanese_driving_license_Image'] }}"></iframe><br/>
                        @else
                        <img class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['sudanese_driving_license_Image'] }}" alt=" صورة توقيع اقرار تسليم الجواز " ><br/>
                        @endif
            ...
            {{-- <div class="col-md-4 relatedisVisaPrinted" " @if($data['isVisaPrinted']==0) style="display: none" @endif>
               <div class="form-group" id="visa_image_oldImage">
                  ...
                  <div class="image">
                     ...
                     <iframe  class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['visa_image'] }}"></iframe><br/>
                     @else
                     <img class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['visa_image'] }}" alt=" صورة توقيع اقرار تسليم الجواز " ><br/>
                     @endif
...
<div class="col-md-4 related_appointment_type_second_value" " @if($data['appointment_type']==1) style="display: none" @endif >
   <div class="form-group" id="no_objection_image_oldImage">
      ...
      <div class="image">
         ...
         <iframe  class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['no_objection_image'] }}"></iframe><br/>
         @else
         <img class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['no_objection_image'] }}" alt=" صورة توقيع اقرار تسليم الجواز " ><br/>
         @endif
   ...
   <div class="col-md-4 related_appointment_type_second_value" " @if($data['appointment_type']==1) style="display: none" @endif >
      <div class="form-group" id="old_qid_image_oldImage">
         ...
         <div class="image">
            ...
            <iframe  class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['old_qid_image'] }}"></iframe><br/>
            @else
            <img class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['old_qid_image'] }}" alt=" صورة توقيع اقرار تسليم الجواز " ><br/>
            @endif
            ...
            <div class="form-group">
             ...
             <div class="col-md-4 related_driver_residency_process_status" " @if($data['driver_residency_process_status']!=11) style="display: none" @endif>
               ...
               <div class="image">
                  ...
                  <img class="custom_img" src="{{ secure_asset('assets/admin/uploads').'/'.$data['driver_residency_id_Image'] }}" alt="الصورة الشخصية للسائق" ><br/>
