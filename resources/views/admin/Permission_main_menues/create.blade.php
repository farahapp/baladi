...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  اضافة قوائم رئيسية للصلاحيات     
         </h3>
      </div>
      <div class="card-body">
         <form action="{{ route('permission_main_menues.store') }}" method="post">
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  <button class="btn btn-sm btn-success" type="submit" name="submit">اضف القائمة الرئيسية </button>
