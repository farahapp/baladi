...
<div class="col-12">
   <div class="card">
      ...
      <div class="card-body" id="flats_searchDiv" style="background-size: cover; background-image: url('{{ secure_asset('assets/admin/imgs/doha.webp') }}')">
...
<script src="{{ secure_asset('assets/admin/js/housing.js') }}"></script>
<script>
