...
<div class="col-12">
   <div class="card">
      ...
      <div class="card-body" id="Traffic_Violations_ajax_serachDiv" style="background-size: cover; background-image: url('{{ asset('/../assets/admin/imgs/doha.webp') }}')">
...
<script src="{{ asset('assets/admin/js/maintenance_traffic_violation.js') }}"></script>
<script>
