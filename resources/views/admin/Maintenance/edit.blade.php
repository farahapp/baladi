...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  تعديل بيانات سيارة     
         </h3>
      </div>
      <div class="card-body">
         <form action="{{ route('Maintenance.update',$data['Vechile_Information']['id']) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input  type="text" name="vechile_color" id="vechile_color" class="form-control" value="{{ old('vechile_color',$data['Vechile_Information']['vechile_color']) }}" placeholder="لون المركبة"  >
                  @error('vechile_color')
                  <span class="text-danger">{{ $message }}</span> 
                  @enderror
               </div>
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input  type="date" name="vechile_end_registeration" id="vechile_end_registeration" class="form-control" value="{{ old('vechile_end_registeration',$data['Vechile_Information']['vechile_end_registeration']) }}" placeholder="لون المركبة"  >
      ...
      @enderror
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  <button class="btn btn-sm btn-success" type="submit" name="submit">تعديل بيانات السيارة  </button>
