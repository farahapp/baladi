...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  Deposti Data     
            <input type="hidden" id="token_search" value="{{csrf_token()}}">
            <input type="hidden" id="ajax_update_report_status" value="{{route('SecurityGuard.ajax_update_report_status')}}">
            <input type="hidden" id="ajax_search_url" value="{{route('SecurityGuard.ajax_daily_report_search')}}">
      ...
      <div class="row" style="padding: 5px;">
         ...
         <div class="col-md-3">
            <div class="form-group">
               <label> Search by Deposit Date </label>
         ...
         <div class="col-md-4">
            <div class="form-group">
               <label>  Search by Guard Name </label>
               <select name="search_by_guard_name" id="search_by_guard_name" class="form-control select2 ">
         ...
         <div class="col-md-3">
            <div class="form-group">
               <label> Search By Deposit Status  </label>
               <select    name="report_status_search" id="report_status_search" class="form-control">
                  <option  value="all">All</option>
                  <option   value="0">Not Returned Deposit</option>
                  <option    value="1">Returned Deposit</option>
                  </select>
            </div>
         </div>
...
<script src="{{ secure_asset('assets/admin/js/show_drivers_deposit.js') }}"></script>
