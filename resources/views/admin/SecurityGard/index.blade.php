   ...
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  Drivers Information   
            ...
            <input type="hidden" id="ajax_search_url" value="{{route('SecurityGuard.ajax_search')}}">
                  ...
                  <table>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td style="color:#EF4C2B">{{ $info->driver_name }}</td>
                           ...
                           <td style="color:#FBA82E"><strong>{{ $info->Nationalities->name }}</strong></td>
