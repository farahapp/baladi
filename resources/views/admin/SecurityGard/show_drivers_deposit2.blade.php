   ...
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  Drivers Information   
            ...
            <input type="hidden" id="ajax_search_url" value="{{route('SecurityGuard.ajax_show_drivers_deposit_search')}}">
...
{{-- <script src="{{ secure_asset('assets/admin/js/security_guard.js') }}"></script> --}}
<script src="{{ secure_asset('assets/admin/js/show_drivers_deposit2.js') }}"></script>
