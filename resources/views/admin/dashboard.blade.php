...
<div class="container-fluid"  style="background-size: cover; background-image: url('{{ secure_asset('assets/admin/imgs/doha.webp') }}')">
...
{{-- <div style="
 background-image: url({{ secure_asset('assets/admin/imgs/dashboard4.jpg') }});
 width: 100%;
min-height: 600px;
...
@section('script')
<!-- ChartJS -->
<script src="{{ secure_asset('assets/admin/plugins/chart.js/Chart.min.js') }}"></script>
